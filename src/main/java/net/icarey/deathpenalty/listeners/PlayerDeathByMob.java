        ...
        if (this.plugin.getConfig().getBoolean("penalty_is_percent")) {
            ...
            if (per <= 1 || per > 0) {
                ...
                if (er.transactionSuccess()) {
                    p.sendMessage(ChatColor.RED + "Dieing to " + WordUtils.capitalizeFully(mobtype) + " cost you " + roundedam);
                } else {
            ...
            if (er.transactionSuccess()) {
                p.sendMessage(ChatColor.RED + "Dieing to " + WordUtils.capitalizeFully(mobtype) + " cost you " + am);
            } else {
                p.sendMessage(ChatColor.RED + "An error occured %s");
            }
